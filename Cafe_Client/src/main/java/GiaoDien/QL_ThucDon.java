...
//	static String name;
	 ...
	 */
	public QL_ThucDon() throws UnknownHostException, ClassNotFoundException, IOException {
    ...
    public void loadMaThucDon() throws IOException {
    	socket=  new Socket("192.168.1.141", 6666);
    	thucdonDao = new Client_ThucDon_dao(socket);
    	String nextMaThucDon = thucdonDao.getNextmaThucDon();
    	txt_ma.setText(nextMaThucDon);
    }
